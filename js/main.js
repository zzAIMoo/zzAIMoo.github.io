function showDropDown() {
    document.getElementsByClassName("dropdown-content")[0].hidden = !document.getElementsByClassName("dropdown-content")[0].hidden;
}
...
setInterval(function () {
    ...
    mobileCheck = check; //ritorna true se è mobile
    if (mobileCheck) {
        $('#pb-navbar').addClass('mobile')
        $('#dropdown-content').addClass('mobile')
    } else {
        $('#pb-navbar').removeClass('mobile')
        $('#dropdown-content').removeClass('mobile')
    }
}, 100)
