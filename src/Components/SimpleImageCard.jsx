...
export default class SimpleImageCard extends React.Component {
    render() {
        return (
            <>
                <div className="max-w-xs p-1 bg-purple-300 shadow-2xl shadow-purple-500 rounded-2xl dark:bg-slate-300 dark:shadow-slate-700">
                    ...
                    <div className="px-6 py-4">
                        <div className="mb-2 overflow-x-hidden text-xl font-bold text-black text-ellipsis whitespace-nowrap">
                            ...
                            elit. Velit, aperiam. Delectus vero, dolor
                            praesentium quas doloremque quod, modi dolores
                            exercitationem minima totam soluta eaque sit
                            repellat recusandae perferendis quidem dignissimos.
                        </div>
